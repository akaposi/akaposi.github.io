...
# táblázatban, csak semmi linalg) létrehozása, alapvetű műveleteik.
# 
# *Adatok bevitele, egyszerű adatfeldolgozási műveletek
# Beolvasás fájlból (txt, csv), írás fájlba, a beolvasott adatok
# egyszerű manipulácója (rendezés, keresés, részmátrixok kijelölése).
# 
...
# megoldása során példákkal (pl. ismerve az előző évhez viszonyított
# árszintemelkedést, számoljunk kumulatív változást stb.).
# 
# *Adatelemzés, néhány statisztikai próba
# Diszkrét eloszlások, nagyon egyszerű próba pl. annak ellenőrzésére, hogy
...
# Feladat: a Föld sugara 6378 km. Milyen hosszú az egyenlítő?
...
# * Egy tetszőlegesen hosszú vektor egymás melletti elemeinek különbsége:
...
# * a következő matematikai függvények ábrázolása -5 és 5 x értékek között egy ploton
#   (lásd lines() függvény), különböző színekkel (lásd ?lines):
#   sin, x^2, x^3, exp
